...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Sat Jul 11 22:29:05 2015
# Project:  annulus.pro
# Template: app
...
SOURCES       = src/main.cpp \
		src/MainWindow.cpp \
		src/Looper.cpp build/moc_MainWindow.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/annulus1.0.0/ && $(COPY_FILE) --parents include/MainWindow.h include/Looper.h build/annulus1.0.0/ && $(COPY_FILE) --parents src/main.cpp src/MainWindow.cpp src/Looper.cpp build/annulus1.0.0/ && (cd `dirname build/annulus1.0.0` && $(TAR) annulus1.0.0.tar annulus1.0.0 && $(COMPRESS) annulus1.0.0.tar) && $(MOVE) `dirname build/annulus1.0.0`/annulus1.0.0.tar.gz . && $(DEL_FILE) -r build/annulus1.0.0
...
compiler_moc_header_make_all: build/moc_MainWindow.cpp build/moc_Looper.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) build/moc_MainWindow.cpp build/moc_Looper.cpp
