...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Thu Jul 9 19:16:38 2015
# Project:  annulus.pro
# Template: app
...
SOURCES       = src/MainWindow.cpp \
		src/main.cpp build/moc_MainWindow.cpp
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/annulus1.0.0/ && $(COPY_FILE) --parents include/MainWindow.h build/annulus1.0.0/ && $(COPY_FILE) --parents src/MainWindow.cpp src/main.cpp build/annulus1.0.0/ && (cd `dirname build/annulus1.0.0` && $(TAR) annulus1.0.0.tar annulus1.0.0 && $(COMPRESS) annulus1.0.0.tar) && $(MOVE) `dirname build/annulus1.0.0`/annulus1.0.0.tar.gz . && $(DEL_FILE) -r build/annulus1.0.0
