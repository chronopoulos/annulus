...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Sat Jul 18 02:44:26 2015
# Project:  annulus.pro
# Template: app
...
SOURCES       = src/main.cpp \
		...
		src/Looper.cpp \
		src/AudioThread.cpp \
		src/PlayPauseButton.cpp build/moc_MainWindow.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/annulus1.0.0/ && $(COPY_FILE) --parents include/MainWindow.h include/Looper.h include/AudioThread.h include/PlayPauseButton.h build/annulus1.0.0/ && $(COPY_FILE) --parents src/main.cpp src/MainWindow.cpp src/Looper.cpp src/AudioThread.cpp src/PlayPauseButton.cpp build/annulus1.0.0/ && (cd `dirname build/annulus1.0.0` && $(TAR) annulus1.0.0.tar annulus1.0.0 && $(COMPRESS) annulus1.0.0.tar) && $(MOVE) `dirname build/annulus1.0.0`/annulus1.0.0.tar.gz . && $(DEL_FILE) -r build/annulus1.0.0
