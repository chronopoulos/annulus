...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Fri Jul 17 16:24:06 2015
# Project:  annulus.pro
# Template: app
...
CXXFLAGS      = -m64 -pipe -g -O2 -D_REENTRANT -Wall -W $(DEFINES)
...
SOURCES       = src/main.cpp \
		src/MainWindow.cpp \
		src/Looper.cpp \
		src/AudioThread.cpp build/moc_MainWindow.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/annulus1.0.0/ && $(COPY_FILE) --parents include/MainWindow.h include/Looper.h include/AudioThread.h build/annulus1.0.0/ && $(COPY_FILE) --parents src/main.cpp src/MainWindow.cpp src/Looper.cpp src/AudioThread.cpp build/annulus1.0.0/ && (cd `dirname build/annulus1.0.0` && $(TAR) annulus1.0.0.tar annulus1.0.0 && $(COMPRESS) annulus1.0.0.tar) && $(MOVE) `dirname build/annulus1.0.0`/annulus1.0.0.tar.gz . && $(DEL_FILE) -r build/annulus1.0.0
...
compiler_moc_header_make_all: build/moc_MainWindow.cpp build/moc_Looper.cpp build/moc_AudioThread.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) build/moc_MainWindow.cpp build/moc_Looper.cpp build/moc_AudioThread.cpp
