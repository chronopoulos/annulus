...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Thu Jul 30 17:37:51 2015
# Project:  annulus.pro
# Template: app
...
compiler_moc_header_make_all: build/moc_MainWindow.cpp build/moc_Looper.cpp build/moc_AudioThread.cpp build/moc_PlayPauseButton.cpp build/moc_Annulus.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) build/moc_MainWindow.cpp build/moc_Looper.cpp build/moc_AudioThread.cpp build/moc_PlayPauseButton.cpp build/moc_Annulus.cpp
